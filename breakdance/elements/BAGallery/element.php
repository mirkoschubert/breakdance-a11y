...
{% endif %}',
    ...
    {
        return [['accepts' => 'gallery', 'path' => 'content.content.images'], ['accepts' => 'gallery', 'path' => 'content.content.galleries[].images'], ['accepts' => 'video', 'path' => 'content.content.images[].video'], ['accepts' => 'string', 'path' => 'content.content.images[].caption'], ['accepts' => 'string', 'path' => 'content.content.images[].custom_url'], ['accepts' => 'string', 'path' => 'content.content.galleries[].title'], ['accepts' => 'string', 'path' => 'content.content.galleries[].images[].custom_url'], ['accepts' => 'string', 'path' => 'content.content.galleries[].images[].caption'], ['accepts' => 'video', 'path' => 'content.content.galleries[].images[].video'], ['accepts' => 'image_url', 'path' => 'content.content.galleries[].images[].image']];
    }
