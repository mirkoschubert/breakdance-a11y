...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceA11yElement\\BABlockquote",
...
<path d="M7.031 14c3.866 0 7 3.134 7 7s-3.134 7-7 7-7-3.134-7-7l-0.031-1c0-7.732 6.268-14 14-14v4c-2.671 0-5.182 1.040-7.071 2.929-0.364 0.364-0.695 0.751-0.995 1.157 0.357-0.056 0.724-0.086 1.097-0.086zM25.031 14c3.866 0 7 3.134 7 7s-3.134 7-7 7-7-3.134-7-7l-0.031-1c0-7.732 6.268-14 14-14v4c-2.671 0-5.182 1.040-7.071 2.929-0.364 0.364-0.695 0.751-0.995 1.157 0.358-0.056 0.724-0.086 1.097-0.086z"/>
    ...
    static function designControls()
    {
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', '%', 'vw', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 100, 'max' => 1200, 'step' => 1]],
        true,
        false,
        [],
      ), c(
      ...
      "author",
       ['type' => 'popout']
        ...
        "Icon Position",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => [['value' => 'inline', 'text' => 'Inline'], ['text' => 'Above Text', 'value' => 'above']]],
        false,
        false,
        [],
      ), c(
        ...
        "Alignment",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'left', 'text' => 'Left', 'icon' => 'AlignLeftIcon'], ['text' => 'Center', 'value' => 'center', 'icon' => 'AlignCenterIcon'], ['text' => 'Right', 'value' => 'right', 'icon' => 'AlignRightIcon']], 'condition' => ['path' => 'design.quotes.icon_position', 'operand' => 'equals', 'value' => 'above']],
        false,
        false,
        [],
      ), c(
        ...
        "Size",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', 'custom'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 10, 'max' => 100, 'step' => 1], 'condition' => ['path' => 'design.quotes.icon', 'operand' => 'is set', 'value' => null]],
        true,
        false,
        [],
      ), c(
        ...
        "Before Author",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px', 'em', 'rem', 'calc'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 80, 'step' => 1]],
        true,
        false,
        [],
      ), getPresetSection(
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.content.author'], ['accepts' => 'string', 'path' => 'content.content.text']];
    }
